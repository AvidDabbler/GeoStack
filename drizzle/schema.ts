...
export type TCAgency = InferModel<typeof tcAgency>; // return type when queried
export const zInsertTCAgency = createInsertSchema(tcAgency);
export const zSelectTCAgency = createSelectSchema(tcAgency);
export type ZInsertTCAgency = z.infer<typeof zInsertTCAgency>;
export type ZSelectTCAgency = z.infer<typeof zSelectTCAgency>;
...
export const account = pgTable(
  "account",
  {
    ...
    tcAgencyId: text("tc_agency_id")
      .notNull()
      .references(() => tcAgency.tcAgencyId),
  ...
  (table) => {
    return {
      ...
      tcAgencyIdUserIdKey: uniqueIndex("account_tc_agency_id_userId_key").on(
        table.userId,
        table.tcAgencyId
      ),
    };
...
export type Account = InferModel<typeof account>; // return type when queried
export const zInsertAccount = createInsertSchema(account);
export type ZInsertAccount = z.infer<typeof zInsertAccount>;
export const zSelectAccount = createSelectSchema(account);
export type ZSelectAccount = z.infer<typeof zSelectAccount>;
...
export type Token = InferModel<typeof token>; // return type when queried
export const zInsertToken = createInsertSchema(token);
export type ZInsertToken = z.infer<typeof zInsertToken>;
export const zSelectToken = createSelectSchema(token);
export type ZSelectToken = z.infer<typeof zSelectToken>;
...
export type ZInsertUser = z.infer<typeof zInsertUser>;
export const zSelectUser = createSelectSchema(user);
export type ZSelectUser = z.infer<typeof zSelectUser>;
...
export type Conversation = InferModel<typeof conversation>; // return type when queried
export const zInsertConversation = createInsertSchema(conversation);
export const zSelectConversation = createSelectSchema(conversation);
export type ZSelectConversation = z.infer<typeof zSelectConversation>;
export type ZInsertConversation = z.infer<typeof zInsertConversation>;
...
export const chat = pgTable(
  ...
  (table) => {
    return {
      chatTcAgencyIdAccountIdFkey: foreignKey({
        columns: [table.tcAgencyId, table.accountId],
        foreignColumns: [account.id, account.tcAgencyId],
      }),
    };
  }
);
export type Chat = InferModel<typeof chat>; // return type when queried
export const zInsertChat = createInsertSchema(chat);
export const zSelectChat = createSelectSchema(chat);
export type ZSelectChat = z.infer<typeof zSelectChat>;
export type ZInsertChat = z.infer<typeof zInsertChat>;

export const conversationType = pgTable(
  "ConversationType",
  {
    id: uuid("id")
      .default(sql`uuid_generate_v4()`)
  ...
  (table) => {
    return {
      typeTcAgencyIdKey: uniqueIndex(
        "ConversationType_type_tc_agency_id_key"
      ).on(table.tcAgencyId, table.type),
      nameTcAgencyIdKey: uniqueIndex(
        "ConversationType_name_tc_agency_id_key"
      ).on(table.tcAgencyId, table.name),
    };
  }
);
export type ConversationType = InferModel<typeof conversationType>; // return type when queried
export const zInsertConversationType = createInsertSchema(conversationType);
export const zSelectConversationType = createSelectSchema(conversationType);
export type ZSelectConversationType = z.infer<typeof zSelectConversationType>;
export type ZInsertConversationType = z.infer<typeof zInsertConversationType>;
...
export type Password = InferModel<typeof password>; // return type when queried
export const zInsertPassword = createInsertSchema(password);
export const zSelectPassword = createSelectSchema(password);
export type ZSelectPassword = z.infer<typeof zSelectPassword>;
export type ZInsertPassword = z.infer<typeof zInsertPassword>;
